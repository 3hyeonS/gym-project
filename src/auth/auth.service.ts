import { ConflictException, Injectable, Logger, Res, UnauthorizedException } from '@nestjs/common';
...
export class AuthService {
    ...
    // 로그인
    async signIn(signInRequestDto: SignInRequestDto): Promise<{ jwtToken: string, user: UserEntity }> {
    ...
    // 카카오 로그인
    async signInWithKakao(kakaoAuthResCode: string): Promise<{ jwtToken: string, user: UserEntity }> {
